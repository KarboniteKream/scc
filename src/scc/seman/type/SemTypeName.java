...
public class SemTypeName extends SemType
{
	...
	public void setType(SemType type)
	{
		if (this.type == null)
			...
			Report.error("Internal error :: scc.seman.type.SemTypeName.setType(SemType type)");
	}
	...
	public SemType getType()
	{
		if (this.type != null)
			...
			Report.error("Internal error :: scc.seman.type.SemTypeName.getType()");
			return null;
		}
	}
