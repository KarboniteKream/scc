...
public class Build
{
	...
	public void build(LinkedList<ImcChunk> chunks)
	{
		...
		// raje ime programa?
		// preveri, kaj start X in end IME pomenita. IME bi moral pomeniti, kje se zacne program, X pa zacetek kode?
		main.asmcode.add(new AsmLABEL("`l0", new FrmLabel("FP")));
		// move address
		main.asmcode.add(new AsmOPER("WORD", "X'001000'"));
		main.asmcode.add(new AsmLABEL("`l0", new FrmLabel("SP")));
		main.asmcode.add(new AsmOPER("WORD", "X'001000'"));
		main.asmcode.add(new AsmLABEL("`l0", new FrmLabel("ADDR")));
		main.asmcode.add(new AsmOPER("RESW", "1"));
		...
		// labele se ne smejo zaceti s _. je to kriv simulator?
